  ...
  - generic [ref=e9]:
    - generic [ref=e10]:
      ...
      - generic [ref=e14]:
        ...
        - textbox "Email" [ref=e16]: test@test.com
      - generic [ref=e17]:
        - generic [ref=e18]: Contraseña
        - textbox "Contraseña" [ref=e19]: "123"
        - paragraph [ref=e20]: La contraseña debe tener al menos 8 caracteres y contener letras y números.
    - generic [ref=e22]: La contraseña debe tener al menos 8 caracteres
    - button "Crear cuenta" [active] [ref=e24] [cursor=pointer]:

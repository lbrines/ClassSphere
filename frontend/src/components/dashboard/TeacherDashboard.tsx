...
export function TeacherDashboard() {
  ...
  if (isLoading) return <div className="text-center py-8">Loading teacher dashboard...</div>
        ...
        <div className="bg-card rounded-lg border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-secondary p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold">{data.stats?.my_courses || 0}</p>
            </div>
            <div className="bg-secondary p-4 rounded-lg">
              <h4 className="font-medium">Total Students</h4>
              <p className="text-2xl font-bold">{data.stats?.total_students || 0}</p>
            </div>
            <div className="bg-secondary p-4 rounded-lg">
              <h4 className="font-medium">Pending Grades</h4>
              <p className="text-2xl font-bold">{data.stats?.pending_grades || 0}</p>
            </div>
          </div>
        </div>
      )}
